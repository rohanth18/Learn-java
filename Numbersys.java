...
public static void main(String[] args)
{
    ...
    if(binary)
    {
         System.out.println("this is binary and radix base is 2");
    }    
    else if(octal)
    {
    ...
    {
         System.out.println("this is decimal and radix base is 10");
    }else if(hexadecimal)
    {
         System.out.println("this is hexadecimal and radix base is 16");
    }
